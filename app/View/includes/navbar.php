...
<header class="z-40 fixed w-screen py-4 flex bg-primary-100  shadow-md dark:bg-gray-800">
  <nav class="container mx-auto w-full flex justify-between items-center h-full px-6 text-gray-600 dark:text-gray-300">
    <div id="logo" class="flex items-center z-40">
      <a href="home" class="flex ml-4 md:mr-24 gap-5 items-center">
        <svg width="35" height="35" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M43.53 5.3C43.53 4.22 44.13 3.82 45.28 3.82C46.43 3.82 82.89 3.68 83.5 3.68C84.1 3.68 84.78 4.28 84.71 5.09C84.64 5.9 84.78 17.32 84.71 17.92C84.64 18.52 84.31 19.2 83.43 19.26C82.56 19.33 45.75 19.46 45.01 19.46C44.27 19.46 43.67 18.59 43.6 17.78C43.53 16.97 43.53 5.97 43.53 5.3Z"
            fill="#546F7B" />
    ...
    <button class="p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple"
      @click="toggleSideMenu" aria-label="Menu"> <svg class="w-6 h-6" aria-hidden="true" fill="currentColor"
        viewBox="0 0 20 20">
