                    ...
                    <form action="Signup/registerUser" method="POST" id="form">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="sm:col-span-2 formGroup">
                                ...
                                <input type="password" name="password" id="password" placeholder="••••••••" class="bg-gray-100 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-orange focus:border-orange block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" minlength="8" required>
                                <p class="error mt-2 text-sm text-red-600 dark:text-red-500 drop-shadow-md hidden"></p>

                            </div>
                            <div class="sm:col-span-2 formGroup">
                                <label for="confirm_password" class="block mb-2 text-sm font-medium text-gray-100 dark:text-white">Confirm
                                    password</label>
                                <input type="password" name="confirm_password" match="password" id="confirm_password" placeholder="••••••••" class="bg-gray-100 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-orange focus:border-orange block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" match='password' required>
                                <p class="error mt-2 text-sm text-red-600 dark:text-red-500 drop-shadow-md hidden"></p>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-start formGroup">
                                        <div class="flex items-center h-5">
                                            <input id="terms-conditions" aria-describedby="terms-conditions" type="checkbox" name="terms_conditions" class="w-4 h-4 border border-gray-300 rounded bg-gray-100 focus:ring-3 focus:ring-orange-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-orange-600 dark:ring-offset-gray-800" required>
                                        </div>
                                        <div class="ml-3 text-sm">
                                            <label for="terms-conditions" class="text-gray-300 dark:text-gray-300">I
                                                agree with
                                                the<a href="#" class="text-sm font-medium text-orange hover:underline dark:text-orange drop-shadow-md ml-1">
                            ...
                            <div class="sm:col-span-2">
                                <button type="submit" class="w-full text-white bg-orange hover:bg-orange focus:ring-4 focus:outline-none focus:ring-orange font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange dark:hover:bg-orange dark:focus:ring-orange">Create
                                    Account</button>
                                <p class="text-sm font-light text-gray-300 dark:text-gray-400 mt-4">
                                    Already have an account <a href="signin" class="font-medium text-orange hover:underline dark:text-orange drop-shadow-md ml-1">Sign
                                        in</a>
                                </p>
                            </div>
                        </div>
