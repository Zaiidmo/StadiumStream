        ...
        <div id="profile-card" class="p-16 pl-24">
            <div class="p-8 bg-white rounded-lg  dark:bg-gray-900 shadow mt-24">
                <div class="grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div class="relative">
                        <div class="w-48 h-48 bg-indigo-100 mx-auto rounded-full shadow-2xl absolute inset-x-0 top-0 -mt-24 flex items-center justify-center dark:text-white text-indigo-500"><svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="mt-20 text-center ">
                    <h1 class="text-4xl font-medium dark:text-white text-gray-700">Jessica Jones, <span class="font-light text-gray-500">27</span></h1>
                    <p class="font-light text-gray-600 dark:text-white mt-3">Bucharest, Romania</p>
                    <p class="mt-8 text-gray-500 dark:text-white">Solution Manager - Creative Tim Officer</p>
                    <p class="mt-2 text-gray-500 dark:text-white">University of Computer Science</p>
                </div>
