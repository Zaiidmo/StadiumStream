    ...
    <main id="main" class="mt-2 px-10 lg:mt-5 lg:px-28 ">
        <div class="grid grid-cols-3 gap-4 pt-6 xl:gap-4 ">
            ...
            <div class="col-span-full xl:col-auto mt-10">
                <div id="profile-pic" class="items-center p-6 sm:flex gap-16 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4 mb-4 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm 2xl:col-span-2 bg-white dark:bg-gray-800">
                    <img class="rounded-lg w-36 h-36 sm:mb-0 xl:mb-4 2xl:mb-0" src="https://images.unsplash.com/photo-1502378735452-bc7d86632805?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=200&fit=max&s=aa3a807e1bbdfd4364d1f449eaa96d82" alt="Jese picture">
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <button type="button" class="py-2 px-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200  hover:bg-orange hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-orange">
                                Delete
                            </button>
                        </div>
                    </div>
                </div>
                <div id="language-settings" class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                ...
                <div id="socialmedia" class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                    <div class="flow-root">
        ...
        <!-- Bottom Side -->
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-4 mb-4 pt-6 xl:gap-4">
