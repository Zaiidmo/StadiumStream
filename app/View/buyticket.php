                            ...
                            <div class="flex  flex-col  items-start  mx-auto max-w-7xl px-2 pt-2 pb-10 sm:px-8 lg:pt-4">
                                ...
                                <div class="">
                                    <div class="flex justify-between">
                                        <div class="text-dark-1 text-4xl leading-none text-right py-2">
                                    ...
                                    <a class="inline-flex items-center justify-center bg-blue-400 text-white h-10 px-5 rounded-lg text-sm font-medium leading-none transition-all duration-200 whitespace-nowrap disabled:opacity-50 disabled:cursor-default hover:bg-blue-4 w-full" href="#">
