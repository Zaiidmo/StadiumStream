...
<body>
    ...
    <section class="signin-gradient z-9  dark:bg-gray-900 font-poppins relative ">
        ...
        <div class="flex  flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div class="w-full z-10 bg-primary-100 rounded-2xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <form class="space-y-4 md:space-y-6" id="form" action="#">
                        <div class="formGroup">
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-100 dark:text-white">Your
                                email</label>
                            <input type="email" name="email" id="email" class="bg-gray-100 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-orange focus:border-orange block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@example.com" pattern="^(.+)@(.+)$" required>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-start formGroup">
                                <div class="flex items-center h-5">
                                    <input id="remember" name="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-100 focus:ring-3 focus:ring-orange dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-orange dark:ring-offset-gray-800" required>
                            ...
                            <a href="#" class="text-sm font-medium text-orange hover:underline dark:text-orange drop-shadow-md">Forgot
                                password?</a>
                        </div>
                        <button type="submit" class="w-full text-white bg-orange hover:bg-orange focus:ring-4 focus:outline-none focus:ring-orange font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange dark:hover:bg-orange dark:focus:ring-orange">Sign
                            in</button>
                        <p class="text-sm font-light text-gray-300 dark:text-gray-400">
                            Don't have an account yet? <a href="signup" class="font-medium text-orange hover:underline dark:text-orange drop-shadow-md">Sign
                                up</a>
                        </p>
                    </form>
                </div>
