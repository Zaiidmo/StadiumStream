...
<body>
    ...
    <section class="contact-gradiant  dark:bg-gray-900 font-poppins relative md:py-28">
        ...
        <div class="flex flex-col items-center justify-center  px-6 py-8  md:h-screen">
            <div
                class="bg-primary-100 rounded-2xl shadow dark:border my-2 md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4  md:space-y-6 sm:p-8">
                    ...
                    <form action="#" id="form">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="sm:col-span-2 formGroup">
                                <button type="submit"
                                    class="w-full text-white bg-orange  focus:ring-4 focus:outline-none focus:ring-orange  font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange  dark:hover:bg-orange-700 dark:focus:ring-orange-800">Send</button>
                            </div>
                            ...
                            <div class="w-full flex justify-center align-middle">
                                <svg class="my-auto" xmlns="http://www.w3.org/2000/svg" width="28" height="28"
