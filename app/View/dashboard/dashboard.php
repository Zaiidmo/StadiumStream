            ...
            <div class="container px-6 mx-auto grid">
                        ...
                        <div class="p-3 mr-4 rounded-full">
                            <span
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="text-orange self-center dark:text-primary-100" width="40" height="40"
                                    viewBox="-2 0 30 24">
                                    <path fill="currentColor"
                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    <div class="w-full overflow-x-auto">
                        <h2
                            class="my-6 text-2xl font-semibold font-poppins tracking-widest text-gray-700 dark:text-gray-200">
                            Up comming Games
                        </h2>
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-xs">
                                        <span
                                            class="px-2 py-1 font-semibold leading-tight text-white bg-green-100 rounded-full dark:bg-primary-100 dark:text-white">
                                            200
                                        </span>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
